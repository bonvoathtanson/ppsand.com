var Print = function(displayTitle, options, data) {
    ...
    windowprint.document.write('@media print{.no-print,.no-print *{display: none !important;}}');
    ...
    windowprint.document.write('<div class="font-HA center" style="font-size:11pt;">អាស័យដ្ឋានៈ វិថីស៊ីសុវិត្ថិ សង្កាត់ស្រះចក ខណ្ឌដូនពេញ រាជធានីភ្នំពេញ</div>');
    windowprint.document.write('<div class="font-HA center" style="font-size:11pt;">លេខទូរស័ព្ទៈ ០១៧​ ៨៦ ៨៨ ៦៧</div>');
